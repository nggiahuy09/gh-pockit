...
| T6   | `TransactionRepositoryImpl` + mapper + repository test. **Quyết lại từ đầu** chính sách "1 row hỏng → fail cả list" của W2 T6: với 5 account thì cân, với 50k transaction thì nó giấu cả năm lịch sử — chép nguyên là failure mode (ADR-0006) |
