...
| T3             | `analysis_options.yaml` strict (very_good_analysis hoặc custom), `dart format` hook, tạo `docs/` + copy blueprint vào `docs/blueprint.md`, copy `CLAUDE.md` | 🟨 Một phần — `docs/` + `CLAUDE.md` xong; còn strict lint + format hook |
